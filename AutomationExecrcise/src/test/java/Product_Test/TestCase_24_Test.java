...
public class TestCase_24_Test extends BaseConfig {

	@Test
	public void Download_Invoice_after_purchase_order() throws InterruptedException, EncryptedDocumentException, IOException {
		
		TestCase_24_Test classObj=new TestCase_24_Test();
		...
		paymentPageObj.clickDownloadInvoice();
		Reporter.log("invoice is downloaded successfully",true);

		// 20. Click 'Continue' button
		paymentPageObj.clickContinueButton();
